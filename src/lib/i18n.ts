...
const resources = {
  en: {
    translation: {
      ...
      'dashboard.analyticsSubtitle': 'Latest stats at a glance',
  ...
  ar: {
    translation: {
      ...
      'dashboard.analyticsTitle': 'لوحة التحليلات',
      'dashboard.analyticsSubtitle': 'نظرة عامة على الإحصائيات',
      'dashboard.goodMorning': 'صباح الخير',
      'dashboard.goodAfternoon': 'طاب نهارك',
